...
.directive('ngTouchSpin', ['$timeout', '$interval', function($timeout, $interval) {
	...
	return {
		...
		'    <button class="btn btn-default" ng-mousedown="startSpinDown()" ng-mouseup="stopSpin()" ng-mouseleave="stopSpin()"><i class="fa fa-minus"></i></button>' +
		'  </span>' +
		...
		'  <span class="input-group-btn" ng-show="!verticalButtons">' +
		'    <button class="btn btn-default" ng-mousedown="startSpinUp()" ng-mouseup="stopSpin()" ng-mouseleave="stopSpin()"><i class="fa fa-plus"></i></button>' +
		'  </span>' +
		'</div>'
	};
